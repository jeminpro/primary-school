            ...
            <div className="hero-content flex-col md:flex-row gap-8 p-8">
              ...
              <div>
                ...
                <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <Link to="/alphabets/learn" className="card bg-gradient-to-r from-emerald-400 to-cyan-400 border border-base-300 hover:shadow-2xl transition">
                  ...
                  <Link to="/alphabets/test" className="card bg-gradient-to-r from-indigo-400 to-cyan-400 border border-base-300 hover:shadow-2xl transition">
                    <div className="card-body">
                      <div className="flex items-center gap-3">
